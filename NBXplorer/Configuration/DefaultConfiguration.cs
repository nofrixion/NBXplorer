...
namespace NBXplorer.Configuration
{
	public class DefaultConfiguration : StandardConfiguration.DefaultConfiguration
	{
		protected override CommandLineApplication CreateCommandLineApplicationCore()
		{
			...
			app.Option("--signetchallenge | -signetchallenge", $"Set a custom challenge for Bitcoin signet", CommandOptionType.SingleValue);
		...
		public static ChainName GetNetworkType(IConfiguration conf)
		{
			...
			var signetChallenge = conf.GetOrDefault<string>("signetchallenge", null);
			if (signetChallenge != null)
			{
				return Bitcoin.Instance.InitCustomSignet("signet-custom", signetChallenge, null).ChainName;
			}
